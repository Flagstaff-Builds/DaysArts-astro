    ...
    <div class="relative isolate overflow-hidden bg-gradient-to-b from-indigo-100/20">
      <div class="mx-auto max-w-7xl pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-40">
        ...
        <div class="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
          ...
          <div class="shadow-lg md:rounded-xl">
...
<pre class="text-[0.8125rem] leading-6 text-gray-300" style="tab-size: 2"><code>import { <span class="text-[#7dd3fc]">useState</span> } from <span class="text-emerald-300">'react'</span>
import { <span class="text-[#7dd3fc]">Switch</span> } from <span class="text-emerald-300">'@headlessui/react'</span>

<span class="text-indigo-400">function Example</span>() {
...
&lt;/<span class="text-indigo-400">form</span>&gt;
                ...
                <div class="pointer-events-none absolute inset-0 ring-1 ring-inset ring-black/10 md:rounded-xl" aria-hidden="true" />
              </div>
            </div>
          </div>
        </div>
